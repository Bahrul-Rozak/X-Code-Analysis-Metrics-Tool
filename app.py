...
def main():
    ...
    tab1, tab2, tab3, tab4 = st.tabs(
        ["Code Analysis", "Reserved", "Identifiers", "AST"])
    ...
    if submit_button:
        with tab1:
            ...
            col2.metric(label="Cyclomatic complexity",
                        value=f"{cc_results[0]}")
        ...
        with tab2:
            ...
            with t3:
                fig2 = px.pie(values=results["reserved"].values(
                ), names=results["reserved"].keys())
